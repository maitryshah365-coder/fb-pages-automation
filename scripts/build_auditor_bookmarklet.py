...
def build():
  ...
  // Pre-seed Roberts Richard as verified ready
  ...
  // Detect active page from i_user cookie, URL, or fallback to Roberts Richard
  ...
  // Populate page selector & pages list
  ...
  document.getElementById('raj-btn-sync').onclick=function(){
    ...
    for html_path in ['docs/index.html', 'web/index.html']:
        ...
        new_content = re.sub(r'js/gold_app\.js\?v=[\d\.]+', 'js/gold_app.js?v=8.9.8', new_content)
